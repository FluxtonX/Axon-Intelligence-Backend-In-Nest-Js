...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'uuid-of-contract', description: 'The ID of the completed contract' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Great to work with!', description: 'Optional feedback comment' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
