...
let NotificationsController = class NotificationsController {
    ...
    async triggerTestNotification(req) {
        const userId = req.user.id;
        return this.notificationsService.sendNotification(userId, 'System Live!', 'Notifications are fully integrated into Proposals, Contracts, and Messages!', 'SYSTEM');
    }
};
